    ...
    return (
        <div className="skill-wrapper" id="skills">
            ...
            <div className="fe-body">
                ...
                {/* <FlipCard devIcon={"devicon-typescript-plain"} stars={4} half={1} lang={"TypeScript"} hide={true}/>
                <FlipCard devIcon={"devicon-angularjs-plain"} stars={4} half={1} lang={"Angular 2+"} hide={true}/>
                <FlipCard devIcon={"devicon-react-original"} stars={4} half={1} lang={"React.js"} hide={true}/> */}
